                            ...
                            <tbody>
                                @foreach($visual as $visual)
                                    <tr class="table_row ">
                                        ...
                                        <td style="text-align:center;"><a href="/details/{{$visual->id}}/{{$visual->user_id}}"><input type="submit" name="submit" value="Submit" class="btn text-black table_data" style="background:#74e5d2 "></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
