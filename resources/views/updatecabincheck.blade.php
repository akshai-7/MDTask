                                ...
                                <tbody>
                                    @foreach($cabin as $cabin)
                                        <tr class="table_row ">
                                            ...
                                            <td style="text-align:center;"><a href="/details/{{$cabin->id}}/{{$cabin->user_id}}"><input type="submit" name="submit" value="Submit" class="btn text-black table_data " style="background:#74e5d2 "></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
