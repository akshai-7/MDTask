                ...
                <tbody>
                    @foreach($report as $report)
                        ...
                        <tr>
                            ...
                            <a href="/store/{{$report->id}}" data-toggle="tooltip" title="View"><i class="fa-solid fa-eye btn btn-primary" ></i></a>
                        ...
                        <tbody>
                            @foreach($driver as $driver)
                                 <tr>
                                    ...
                                    <td style="text-align:center;">
                                    <a href="index1/{{$driver->id}}" data-toggle="tooltip" title="View"><i class="fa-solid fa-eye btn btn-primary" ></i></a>
                                    <a href="delete/{{$driver->id}}" ><i class="fa-solid fa-trash btn btn-danger"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
